...
namespace DatingSite.API.Migrations
{
    ...
    [Migration("20191018160805_addeMessage")]
    partial class addeMessage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingSite.API.Models.LikesModel", b =>
                {
            ...
            modelBuilder.Entity("DatingSite.API.Models.MessagesModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DatingSite.API.Models.LikesModel", b =>
                {
                    b.HasOne("DatingSite.API.Models.UserModel", "UserIsLiked")
                        .WithMany("UserLikes")
                        .HasForeignKey("UserIsLikedId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DatingSite.API.Models.UserModel", "UserLikes")
            ...
            modelBuilder.Entity("DatingSite.API.Models.MessagesModel", b =>
                {
                    b.HasOne("DatingSite.API.Models.UserModel", "Recipient")
                        .WithMany("MessagesRecived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DatingSite.API.Models.UserModel", "Sender")
